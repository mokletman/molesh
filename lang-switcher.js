(function () {
    ...
    function placeButton() {
        ...
        btn.textContent = getLang() === 'en' ? 'ID' : 'EN';
    ...
    function placeManagementButton() {
        ...
        link.style.fontSize = '.62rem';
        link.style.fontWeight = '800';
        link.style.letterSpacing = '.55px';
